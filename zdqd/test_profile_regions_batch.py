"""
批量测试个人页区域检测模型 - 100次识别测试
Batch Test Profile Regions Detection Model - 100 Recognition Tests
"""
...
async def test_batch():
    ...
    test_dirs = [
        ...
        'yolo_dataset/profile_regions/images/train',
    ]
    ...
    if fail_count > 0:
        ...
        for i, result in enumerate(results, 1):
            if not result['success']:
                print(f"  测试 {i}: {result.get('error', '识别不完整')}")
