"""
登录专用模型训练脚本
训练类别：首页、登录页、积分页、个人页已登陆、个人页未登陆、用户名或密码错误、手机号码不存在
支持GPU加速、混合精度训练、详细进度日志
"""
# [2026-03-01] 修改原因：统一训练框架，与签到/资料/转账专用模型保持一致
...
def main():
    ...
    best_val_acc = 0.0
    best_model_path = models_dir / "page_classifier_login_best.pth"
    ...
    # 保存类别列表
    classes_path = models_dir / "page_classes_login.json"
