...
# ============ 配置区域 ============
# 指定要训练的类别（获取资料流程需要的页面）
# [2026-03-01] 修改原因：加入"个人页广告"类别，提高资料获取流程的准确性
SELECTED_CLASSES = [
    "个人页已登陆",
    "个人页未登陆",
    "个人页广告",
...
class PageClassifier(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        # [2026-03-01] 修复原因：改用MobileNetV3-Large以与签到和启动流程保持一致
...
def main():
    ...
    best_val_acc = 0.0
    best_model_path = models_dir / "page_classifier_profile_best.pth"
    ...
    # 保存类别列表
    classes_path = models_dir / "page_classes_profile.json"
